<hr><ul class="sidebar-menu">
            <li class="menu-header"><center><h4 style="color:black;">Menu</h4></center></li>
            <li class="dropdown active">
              <a href="<?php echo base_url();?>index.php/login/index" class="nav-link"><i data-feather="monitor"></i><span>Dashboard</span></a>
